...
public class AnagramSetting {
    ...
    public void addParticipant(long participantId) {
        if (participantId != this.memberId) {
    ...
    public boolean isParticipant(long participantId) {
        return participantId != this.memberId && this.participants.contains(participantId);
    }
    ...
    public int getScore(Integer len) {
        ...
        return this.roundToHundreds(71.4286 * (double)len * (double)len + -234.286 * (double)len + 372.857) + streakBonus;
    }
    ...
    public MessageEmbed endingEmbedBuild() {
        ...
        if (this.gameMode.equals("solo")) {
            ...
            embedDescription = "<@" + this.memberId + "> Your final score was: **" + this.getFinalScore() + "**\nYour rank is: " + this.getRank() + "\n\nLetters for this anagram: ";
            ...
            embedDescription = embedDescription + "\nParticipants in this anagram: <@" + this.memberId + ">";
    ...
    public MessageEmbed endingEmbedBuild(AnagramSetting opponentAnagramSetting) {
        if (this.gameMode.equals("comp")) {
            ...
            embedDescription = embedDescription + "**\n\n<@" + this.memberId + "> Your final score was: **" + this.getFinalScore() + "**\n";
